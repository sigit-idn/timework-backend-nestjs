...
You can now head to `http://localhost:4000/docs` and see your API Swagger docs. The example employee API is located at the `http://localhost:4000/api/v2/employees` endpoint.
...
│   ├── employee/  # A module example that manages "employee" resources
│   │   ├── controller/
│   │   │   └── employee.controller.ts
│   │   ├── flow/  # The "flow" directory contains the pipes, interceptors and everything that may change the request or response flow
│   │   │   └── employee.pipe.ts
│   │   ├── model/
│   │   │   ├── employee.data.ts  # The model that will be returned in the response
│   │   │   ├── employee.entity.ts  # The actual TypeORM entity
│   │   │   └── employee.input.ts  # The model that is used in the request
│   │   ├── employee.module.ts
│   │   ├── service/
│   │   │   └── employee.service.ts
│   │   └── spec/
